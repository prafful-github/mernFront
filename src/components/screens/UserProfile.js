    ...
    return(
        <div>
            ...
            {UserProfile ?
                        ...
                        <div style={{display:"flex", justifyContent:"space-around", margin:"18px 0", borderBottom:"1px solid gray"}}>
                        <div>
                            <img alt="img" style={{width:"160px", height:"160px", borderRadius:"80px"}} src={UserProfile.user.pic} />
                        </div>
                        <div>
